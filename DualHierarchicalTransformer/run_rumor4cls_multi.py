...
class RumorProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir, fold):
        ...
        for lang in ["en", "th", "vi", "id", "ms"]:
            logger.info("LOOKING AT {}".format(os.path.join(data_dir, lang, fold, "train.tsv")))
    ...
    def get_dev_examples(self, data_dir, fold):
        ...
        lines = []
        for lang in ["en", "th", "vi", "id", "ms"]:
            logger.info("LOOKING AT {}".format(os.path.join(data_dir, lang, fold, "dev.tsv")))
            _lines = self._create_examples(
...
def main():
    ...
    if args.do_train:
        train_examples = processor.get_train_examples(args.data_dir, args.fold)
        num_train_steps = int(
    ...
    if args.do_train:
        ...
        #'''
        eval_examples = processor.get_dev_examples(args.data_dir, args.fold)
        print('dev data')
        ...
        '''
        test_examples = processor.get_test_examples(args.data_dir, args.fold)
        print('test data')
