...
def load5foldData():
    ...
    folds_dict = {}
    for i, cur_key in enumerate(event_whitelist):
        ...
        test_fname = os.path.join(
            par_dir, "Rumor_RvNN/nfold/RNNtestSet_PHEME" + str(i) + "_tree.txt"
        )
        train_fname = os.path.join(
            par_dir, "Rumor_RvNN/nfold/RNNtrainSet_PHEME" + str(i) + "_tree.txt"
        )
