# https://github.com/weilingwei96/EBGCN/blob/e2a7699930fab2b457b2dd903303db93b97de1ad/Process/rand5fold.py
...
def load5foldData(obj, shuffle_flag=True, seed=2020):
    ...
    if "PHEME" in obj:
        ...
        for line in open(labelPath):
            line = (
                line.rstrip()
            )  # false	E272	656955120626880512	2	143	536	532	IJCAI	0.73
    ...
    for i in range(4):
        ...
        with open(test_fname, "w") as filehandle:
            filehandle.writelines(
                "%s\n" % tree_idx for tree_idx in list(test_identifiers[i])
            )
