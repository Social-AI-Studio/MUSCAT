...
# threaddirectory = {}
# actual_threadpath = "../resource_creation/all-rnr-annotated-threads/"
# for mainevent in os.listdir(actual_threadpath):
    # for thread in os.listdir(os.path.join(actual_threadpath,mainevent)):
        # threaddirectory[thread] = os.path.join(actual_threadpath,mainevent,thread) # save all pheme dataset outputs.
###################################################################################################################
###################################################################################################################
###################################################################################################################
###################################################################################################################
