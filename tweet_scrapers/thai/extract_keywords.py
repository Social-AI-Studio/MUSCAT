...
for file in os.listdir(rootdir):
    with open(os.path.join(rootdir, file), 'r') as f:
        ...
        # print(title)
            ...
            keywords_thai = kw_model_multi.extract_keywords(title, keyphrase_ngram_range=(1, 1), top_n=5)
            print(keywords_thai)
            selected_keywords = [i[0] for i in keywords_thai]
            content["keywords"] = selected_keywords
            keywords_eng = [translate_text_with_source(source="th", target="en", text=word) for word in selected_keywords]
