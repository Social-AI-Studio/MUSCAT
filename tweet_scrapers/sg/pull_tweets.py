...
if __name__ == "__main__":
    ...
    root_dir = "blackdot_cleaned_with_keywords"
    for file in os.listdir(root_dir):
        ...
        '''
        if len(keywords) >1:
            keywords_list.append([[start_date_str, end_date_str, "blackdot_raw_results"], [keywords_str]])
    ...
    for i in keywords_list:
        ...
        for hashtag in i[1]:
            ...
            print(
                os.path.join("blackdot_raw_results", hashtag.strip() + "_" + "_".join(i[0][0].split("-")[:2]) + ".json"))
            if os.path.exists(os.path.join("blackdot_raw_results",
                                           hashtag.strip() + "_" + "_".join(i[0][0].split("-")[:2]) + ".json")):
                print(os.path.join("blackdot_raw_results", hashtag + "_" + "_".join(i[0][0].split("-")[:2]) + ".json"),
                      "was done..")
